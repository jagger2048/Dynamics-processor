#include <stdint.h>
#include <stdlib.h>
#include "./nonlinear_processor/NoiseGate.c"
#include "./wavfile/wavfile.c"
#include "./wavfile/dr_wav.h"
//#pragma comment ( lib, "nonlinearProcessorLib.lib")
//#pragma comment ( lib, "wavfileLib.lib")
